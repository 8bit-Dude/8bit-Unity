...
const fix8 vertBox[8][3]  = {{-128,-128,-128},{-128,128,-128},{128,128,-128},{128,-128,-128},
							 {-128,-128, 128},{-128,128, 128},{128,128, 128},{128,-128, 128}};
const char faceBox[12][3] = {{0,1,2},{0,2,3},{0,5,1},{0,4,5}, 
							 {4,6,5},{4,7,6},{3,2,6},{3,6,7}, 
							 {3,4,0},{3,7,4},{1,5,2},{2,5,6}};	

const fix8 vertCon[9][3]  = {{128,0,-128},{91,91,-128},{0,128,-128},{-91,91,-128},{-128,0,-128},{-91,-91,-128},{0,-128,-128},{91,-91,-128},{0,0,128}};
const char faceCon[14][3] = {{0,1,8},{1,2,8},{2,3,8},{3,4,8},{4,5,8},{5,6,8},{6,7,8},{7,0,8},
							 {0,4,1},{1,4,3},{1,3,2},{5,4,0},{7,5,0},{6,5,7}};
			  
const fix8 vertCyl[16][3] = {{128,0,-128},{91,91,-128},{0,128,-128},{-91,91,-128},{-128,0,-128},{-91,-91,-128},{0,-128,-128},{91,-91,-128},
							 {128,0, 128},{91,91, 128},{0,128, 128},{-91,91, 128},{-128,0, 128},{-91,-91, 128},{0,-128, 128},{91,-91, 128}};
const char faceCyl[28][3] = {{1,8,0},{9,8,1},{2,9,1},{10,9,2},{3,10,2},{11,10,3},{4,11,3},{12,11,4},
							 {5,12,4},{13,12,5},{6,13,5},{14,13,6},{7,14,6},{15,14,7},{0,15,7},{8,15,0},
							 {0,4,1},{1,4,3},{1,3,2},{5,4,0},{7,5,0},{6,5,7},
							 {9,12,8},{11,12,9},{11,10,9},{8,12,13},{8,13,15},{15,13,14}};	

const fix8 vertSph[12][3] = {{-67,0,109},{ 67,0,109},{-67,0,-109},{ 67,0,-109},
							 {0,109, 67},{0,109,-67},{0,-109, 67},{0,-109,-67},
							 {109, 67,0},{-109,67,0},{ 109,-67,0},{-109,-67,0}};
const char faceSph[20][3] = {{0,4,1}, {0,9,4}, {9,5,4}, {4,5,8}, {4,8,1},
							 {8,10,1},{8,3,10},{5,3,8}, {5,2,3}, {2,7,3},
							 {7,10,3},{7,6,10},{7,11,6},{11,0,6},{0,1,6},
							 {6,1,10},{9,0,11},{9,11,2},{9,2,5}, {7,2,11}};

const fix8 vertTor[16][3] = {{64,0,0},{96,0,32},{128,0,0},{96,0,-32},
							 {0,64,0},{0,96,32},{0,128,0},{0,96,-32},
							 {-64,0,0},{-96,0,32},{-128,0,0},{-96,0,-32},
							 {0,-64,0},{0,-96,32},{0,-128,0},{0,-96,-32}};
const char faceTor[32][3] = {{0,1,4}, {5,1,4},{1,2,5},{6,2,5},{2,3,6},{7,3,6},{3,4,7},{0,4,7},
...
const char** namePrim[] = { "  BOX  ", " CONE  ", "CYLINDE", "SPHERE ", " TORUS " };
const fix8** vertPrim[] = {  vertBox ,  vertCon ,  vertCyl ,  vertSph ,  vertTor  };
const char** facePrim[] = {  faceBox ,  faceCon ,  faceCyl ,  faceSph ,  faceTor  };
const char   vertCoun[] = {     8    ,     9    ,     16   ,     12   ,     16    };
const char   faceCoun[] = {     12   ,     14   ,     28   ,     20   ,     32    };
