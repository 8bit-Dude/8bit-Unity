...
copy ..\..\projects\goblin\bitmaps\banner-lynx.png banner.png
..\..\utils\scripts\png2bmp banner.png
..\..\utils\scripts\lynx\sprpck -t6 -p2 -u banner.bmp
copy ..\..\projects\goblin\bitmaps\scene1-lynx.png scene1.png
..\..\utils\scripts\png2bmp scene1.png
..\..\utils\scripts\lynx\sprpck -t6 -p2 -u scene1.bmp

copy ..\..\projects\goblin\sprites\sprites-lynx.png sprites.png
..\..\utils\scripts\png2bmp sprites.png
..\..\utils\scripts\lynx\sprpck -t6 -p2 -u -r001014 -S009013 -a004006 sprites.bmp

set /a CHUNKNUM=0
..\..\utils\py27\python ..\..\utils\scripts\ProcessChunks.py lynx ../../projects/goblin/chunks/chunks-lynx.txt ../../build/lynx/
...
..\..\utils\py27\python ../../utils/scripts/lynx/LynxChipper.py ../../projects/goblin/music/goblin-lynx.asm music00.asm _musData00 MUS0DATA"
del *.png /F /Q
del *.bmp /F /Q
del *.pal /F /Q

set FILESIZES=
for %%I in (banner.spr,scene1.spr,music00.asm) do set FILESIZES=!FILESIZES!%%~zI,
...
@echo _fileNames: .addr _bmpName00,_bmpName01,_musName00,%CHUNKNAMES:~0,-1% >> data.asm
@echo _bmpName00: .byte "banner.img",0 >> data.asm
@echo _bmpName01: .byte "scene1.img",0 >> data.asm
@echo _musName00: .byte "goblin.mus",0 >> data.asm
set /a IND=0
...
@echo _bmpData01: .incbin "scene1.spr" >> data.asm
@echo ; >> data.asm
@echo ; >> data.asm
...
@echo ; >> data.asm
@echo .segment "RODATA" >> data.asm
@echo _spriteNum: .byte 14 >> data.asm
@echo _spriteData: .addr _spr000, _spr001, _spr002, _spr003, _spr004, _spr005, _spr006, _spr007, _spr008, _spr009, _spr010, _spr011, _spr012, _spr013 >> data.asm
...
utils\cc65\bin\cl65 -o build/goblin-lynx.lnx -m build/goblin-lynx.map -Cl -O -t lynx -C build/lynx/lynx.cfg -I unity projects/goblin/src/goblin.c projects/goblin/src/chunks.c projects/goblin/src/interface.c projects/goblin/src/scene.c build/lynx/music00.asm unity/Lynx/sfx.s build/lynx/directory.asm build/lynx/data.asm build/lynx/unity.lib
...
handy.exe "..\..\..\build\goblin-lynx.lnx"
