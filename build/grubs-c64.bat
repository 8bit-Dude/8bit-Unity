...
utils\py27\python utils\scripts\c64\C64Bitmap.py projects/grubs/bitmaps/banner-c64.png build/c64/banner.img
utils\py27\python utils\scripts\c64\C64Bitmap.py projects/grubs/bitmaps/pumpkins-c64.png build/c64/pumpkins.img
utils\py27\python utils\scripts\c64\C64Sprites.py projects/grubs/sprites/sprites-c64.png build/c64/sprites.dat
...
utils\cc65\bin\cl65 -o build/c64/grubs.bin -m build/grubs-c64.map -Cl -O -t c64 -C unity/C64/c64.cfg -I unity projects/grubs/src/grubs.c build/c64/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_c64.lib

utils\scripts\exomizer-3.0.2.exe sfx $180d build/c64/grubs.bin build/c64/sprites.dat -o build/c64/loader.prg

echo DONE!

echo --------------- C64 DISK BUILDER --------------- 

set C1541=utils\scripts\c64\c1541 -format loader,666 d64 build/grubs-c64.d64 -attach build/grubs-c64.d64 -write build/c64/loader.prg loader.prg -write build/c64/banner.img banner.img -write build/c64/pumpkins.img pumpkins.img 
