...
luajit PictOric.lua 0.2 ../../../projects/demos/bitmaps/banner-oric.png ../../../build/oric/banner.dat
header -a0 ../../../build/oric/banner.dat ../../../build/oric/banner.img $A000
luajit PictOric.lua 0.2 ../../../projects/demos/bitmaps/stadium-oric.png ../../../build/oric/stadium.dat
header -a0 ../../../build/oric/stadium.dat ../../../build/oric/stadium.img $A000
cd ..\..\..
utils\py27\python utils\scripts\oric\OricSprites.py projects/demos/sprites/sprites-oric.png build/oric/sprites.dat 6
utils\scripts\oric\header -a0 build/oric/sprites.dat build/oric/sprites.dat $7800
utils\scripts\oric\ym2mym projects/demos/music/demo-oric.ym build/oric/demo.mus
utils\scripts\oric\header -h1 -a0 build/oric/demo.mus build/oric/demo.mus $8000
...
utils\cc65\bin\cl65 -o build/oric/demos.bin -m build/demos-oric48k.map -Cl -O -t atmos -C unity/Oric/oric.cfg -I unity projects/demos/src/demo.c projects/demos/src/demo-bitmap.c projects/demos/src/demo-controls.c projects/demos/src/demo-gfx.c projects/demos/src/demo-hello.c projects/demos/src/demo-network.c projects/demos/src/demo-sprites.c build/oric/unity.lib

utils\scripts\oric\header.exe build/oric/demos.bin build/oric/demos.com $0501

utils\scripts\exomizer-3.0.2.exe sfx bin build/oric/demos.com -o build/oric/launch.com
...
set TAP2DSK=utils\scripts\oric\tap2dsk.exe -iLAUNCH.COM build/oric/launch.com build/oric/sprites.dat build/oric/banner.img build/oric/stadium.img build/oric/demo.mus
set TAP2DSK=%TAP2DSK% build/demos-oric48k.dsk
%TAP2DSK%
utils\scripts\oric\old2mfm.exe build/demos-oric48k.dsk

echo DONE
rem pause

rem cd "utils\emulators\Oricutron-1.2-Hub"
rem oricutron.exe -d "..\..\..\build\demos-oric48k.dsk"
