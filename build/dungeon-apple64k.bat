...
utils\py27\python utils\scripts\apple\AppleBitmap.py single projects/dungeon/bitmaps/menu-apple.png build/apple/menu.img
utils\py27\python utils\scripts\apple\AppleCharset.py single projects/dungeon/charmaps/quedex-apple.png build/apple/quedex.chr
utils\py27\python utils\scripts\apple\AppleSprites.py single projects/dungeon/sprites/sprites-apple.png build/apple/sprites.dat 16
...
utils\cc65\bin\cl65 -o build/apple/dungeon.bin -m build/dungeon-apple64k.map -Cl -O -t apple2 -Wl -D,__STACKSIZE__=$0400,-D,__HIMEM__=$BC00,-D,__LCADDR__=$D000,-D,__LCSIZE__=$1000 -C apple2-hgr.cfg -I unity projects/dungeon/src/dungeon.c projects/dungeon/src/interface.c build/apple/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_apple2.lib
...
copy utils\scripts\apple\ProDOS190.dsk build\dungeon-apple64k.do
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -as build/dungeon-apple64k.do LOADER bin 0x0803 < build/apple/loader
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/dungeon-apple64k.do SPRITES.DAT bin < build/apple/sprites.dat
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/dungeon-apple64k.do MENU.IMG bin < build/apple/menu.img
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/dungeon-apple64k.do QUEDEX.CHR bin < build/apple/quedex.chr
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/dungeon-apple64k.do LEVEL1.MAP bin < projects/dungeon/charmaps/level1.map
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/dungeon-apple64k.do LEVEL1.TLS bin < projects/dungeon/charmaps/level1.tls
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/dungeon-apple64k.do DUNGEON.MUS bin < projects/dungeon/music/dungeon-apple.m

echo DONE
pause

cd "utils\emulators\AppleWin-1.26.3.1"
Applewin.exe -d1 "..\..\..\build\dungeon-apple64k.do"
