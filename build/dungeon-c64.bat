...
utils\py27\python utils\scripts\c64\C64Bitmap.py projects/dungeon/bitmaps/menu-c64.png build/c64/menu.img
utils\py27\python utils\scripts\c64\C64Charset.py projects/dungeon/charmaps/quedex-c64.png build/c64/quedex.chr
utils\py27\python utils\scripts\c64\C64Sprites.py projects/dungeon/sprites/sprites-c64.png build/c64/sprites.dat
utils\scripts\c64\sidreloc.exe -v -z 30-ff -p 08 projects/dungeon/music/dungeon-c64.sid build/c64/dungeon.sid
if exist build/c64/dungeon.sid (
    utils\scripts\c64\psid64.exe -n build/c64/dungeon.sid
) else (
    echo Relocation impossible, using the original file instead...
    copy projects\dungeon\music\dungeon-c64.sid build\c64\dungeon.prg
)
...
utils\cc65\bin\cl65 -o build/c64/dungeon.bin -m build/dungeon-c64.map -Cl -O -t c64 -C unity/C64/c64.cfg -I unity projects/dungeon/src/dungeon.c projects/dungeon/src/interface.c build/c64/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_c64.lib

utils\scripts\exomizer-3.0.2.exe sfx $180d build/c64/dungeon.bin build/c64/sprites.dat -o build/c64/loader.prg

echo DONE!

echo --------------- C64 DISK BUILDER --------------- 

set C1541=utils\scripts\c64\c1541 -format loader,666 d64 build/dungeon-c64.d64 -attach build/dungeon-c64.d64 -write build/c64/loader.prg loader.prg -write build/c64/menu.img menu.img -write build/c64/quedex.chr quedex.chr -write projects/dungeon/charmaps/level1.map level1.map -write projects/dungeon/charmaps/level1.tls level1.tls -write build/c64/dungeon.prg dungeon.mus 
