...
utils\py27\python utils\scripts\apple\AppleBitmap.py double projects/goblin/bitmaps/banner-apple.png build/apple/banner.img
utils\py27\python utils\scripts\apple\AppleBitmap.py double projects/goblin/bitmaps/scene1-apple.png build/apple/scene1.img
utils\py27\python utils\scripts\apple\AppleSprites.py double projects/goblin/sprites/sprites-apple.png build/apple/sprites.dat 24
utils\py27\python utils\scripts\ProcessChunks.py apple-double projects/goblin/chunks/chunks-apple.txt build/apple/
...
utils\cc65\bin\cl65 -o build/apple/goblin.bin -m build/goblin-apple128k.map -Cl -O -t apple2 -D __DHR__ -Wl -D,__STACKSIZE__=$0400,-D,__HIMEM__=$BC00,-D,__LCADDR__=$D000,-D,__LCSIZE__=$1000 -C apple2-hgr.cfg -I unity projects/goblin/src/goblin.c projects/goblin/src/chunks.c projects/goblin/src/interface.c projects/goblin/src/scene.c build/apple/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_apple2.lib
...
copy utils\scripts\apple\ProDOS190.dsk build\goblin-apple128k.do
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -as build/goblin-apple128k.do LOADER bin 0x0803 < build/apple/loader
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/goblin-apple128k.do SPRITES.DAT bin < build/apple/sprites.dat
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/goblin-apple128k.do BANNER.IMG bin < build/apple/banner.img
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/goblin-apple128k.do SCENE1.IMG bin < build/apple/scene1.img
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/goblin-apple128k.do GOBLIN.MUS bin < projects/goblin/music/goblin-apple.m
for /f "tokens=*" %%A in (build\apple\chunks.lst) do utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/goblin-apple128k.do %%~nxA bin < %%A 

echo DONE
pause

cd "utils\emulators\AppleWin-1.26.3.1"
Applewin.exe -d1 "..\..\..\build\goblin-apple128k.do"
