...
utils\py27\python utils\scripts\atari\AtariBitmap.py projects/os/bitmaps/hokusai-atari.png build/atari/hokusai.img
utils\py27\python utils\scripts\atari\AtariBitmap.py projects/os/bitmaps/munch-atari.png build/atari/munch.img
utils\py27\python utils\scripts\atari\AtariBitmap.py projects/os/bitmaps/picasso-atari.png build/atari/picasso.img
utils\py27\python utils\scripts\atari\AtariBitmap.py projects/os/bitmaps/vangogh-atari.png build/atari/vangogh.img
utils\py27\python utils\scripts\atari\AtariSprites.py projects/os/sprites/sprites-atari.png build/atari/sprites.dat 6
utils\py27\python utils\scripts\ProcessChunks.py atari projects/os/chunks/chunks-atari.txt build/atari/
copy projects\os\shared\readme.txt build\atari
copy projects\os\music\bazalt-atari.rmt build\atari\bazalt.mus
copy projects\os\music\nirvana-atari.rmt build\atari\nirvana.mus
...
utils\cc65\bin\cl65 -o build/atari/os.bin -m build/os-atari.map -Cl -O -t atarixl -Wl -D,__STACKSIZE__=$0400,-D,__CHARGENSIZE__=$0000 -C atarixl-largehimem.cfg -I unity projects/os/src/os.c projects/os/src/chat.c projects/os/src/files.c projects/os/src/home.c projects/os/src/image.c projects/os/src/mouse.c projects/os/src/music.c unity/Atari/POKEY.s build/atari/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_atarixl.lib
...
utils\py27\python utils\scripts\atari\AtariMerge.py build/atari/xautorun build/atari/basicoff.bin build/atari/os.bin build/atari/rmt.bin
...
utils\scripts\atari\dir2atr.exe -d -B utils/scripts/atari/xboot.obx 720 build/os-atari.atr build\atari

echo DONE
pause

cd "utils\emulators\Altirra-3.20"
Altirra.exe "..\..\..\build\os-atari.atr"
