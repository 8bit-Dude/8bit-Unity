...
utils\py27\python utils\scripts\apple\AppleBitmap.py single projects/os/bitmaps/hokusai-apple.png build/apple/hokusai.img
utils\py27\python utils\scripts\apple\AppleBitmap.py single projects/os/bitmaps/munch-apple.png build/apple/munch.img
utils\py27\python utils\scripts\apple\AppleBitmap.py single projects/os/bitmaps/picasso-apple.png build/apple/picasso.img
utils\py27\python utils\scripts\apple\AppleBitmap.py single projects/os/bitmaps/vangogh-apple.png build/apple/vangogh.img
utils\py27\python utils\scripts\apple\AppleSprites.py single projects/os/sprites/sprites-apple.png build/apple/sprites.dat 7
utils\py27\python utils\scripts\ProcessChunks.py apple-single projects/os/chunks/chunks-apple.txt build/apple/
...
utils\cc65\bin\cl65 -o build/apple/os.bin -m build/os-apple64k.map -Cl -O -t apple2 -Wl -D,__STACKSIZE__=$0400,-D,__HIMEM__=$BC00,-D,__LCADDR__=$D000,-D,__LCSIZE__=$1000 -C apple2-hgr.cfg -I unity projects/os/src/os.c projects/os/src/chat.c projects/os/src/files.c projects/os/src/home.c projects/os/src/image.c projects/os/src/mouse.c projects/os/src/music.c build/apple/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_apple2.lib
...
copy utils\scripts\apple\ProDOS190.dsk build\os-apple64k.do
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -as build/os-apple64k.do LOADER bin 0x0803 < build/apple/loader
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/os-apple64k.do SPRITES.DAT bin < build/apple/sprites.dat
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/os-apple64k.do HOKUSAI.IMG bin < build/apple/hokusai.img
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/os-apple64k.do MUNCH.IMG bin < build/apple/munch.img
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/os-apple64k.do PICASSO.IMG bin < build/apple/picasso.img
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/os-apple64k.do VANGOGH.IMG bin < build/apple/vangogh.img
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/os-apple64k.do DUNGEON.MUS bin < projects/os/music/dungeon-apple.m
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/os-apple64k.do GOBLIN.MUS bin < projects/os/music/goblin-apple.m
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/os-apple64k.do SPEEDNIK.MUS bin < projects/os/music/speednik-apple.m
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/os-apple64k.do README.TXT bin < projects/os/shared/readme.txt
for /f "tokens=*" %%A in (build\apple\chunks.lst) do utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/os-apple64k.do %%~nxA bin < %%A 

echo DONE
pause

cd "utils\emulators\AppleWin-1.26.3.1"
Applewin.exe -d1 "..\..\..\build\os-apple64k.do"
