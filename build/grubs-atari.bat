...
utils\py27\python utils\scripts\atari\AtariBitmap.py projects/grubs/bitmaps/banner-atari.png build/atari/banner.img
utils\py27\python utils\scripts\atari\AtariBitmap.py projects/grubs/bitmaps/pumpkins-atari.png build/atari/pumpkins.img
utils\py27\python utils\scripts\atari\AtariSprites.py projects/grubs/sprites/sprites-atari.png build/atari/sprites.dat 13
...
utils\cc65\bin\cl65 -o build/atari/grubs.bin -m build/grubs-atari.map -Cl -O -t atarixl -Wl -D,__STACKSIZE__=$0400 -C atarixl-largehimem.cfg -I unity projects/grubs/src/grubs.c unity/Atari/POKEY.s build/atari/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_atarixl.lib
...
utils\py27\python utils\scripts\atari\AtariMerge.py build/atari/xautorun build/atari/basicoff.bin build/atari/grubs.bin build/atari/rmt.bin
...
utils\scripts\atari\dir2atr.exe -d -B utils/scripts/atari/xboot.obx 720 build/grubs-atari.atr build\atari

echo DONE
pause

cd "utils\emulators\Altirra-3.20"
Altirra.exe "..\..\..\build\grubs-atari.atr"
