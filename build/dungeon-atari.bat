...
utils\py27\python utils\scripts\atari\AtariBitmap.py projects/dungeon/bitmaps/menu-atari.png build/atari/menu.img
copy projects\dungeon\charmaps\level1.map build\atari
copy projects\dungeon\charmaps\level1.tls build\atari
utils\py27\python utils\scripts\atari\AtariCharset.py projects/dungeon/charmaps/quedex-atari.png build/atari/quedex.chr
utils\py27\python utils\scripts\atari\AtariSprites.py projects/dungeon/sprites/sprites-atari.png build/atari/sprites.dat 18
copy projects\dungeon\music\dungeon-atari.rmt build\atari\dungeon.mus
...
utils\cc65\bin\cl65 -o build/atari/dungeon.bin -m build/dungeon-atari.map -Cl -O -t atarixl -Wl -D,__STACKSIZE__=$0400,-D,__CHARGENSIZE__=$0000 -C atarixl-largehimem.cfg -I unity projects/dungeon/src/dungeon.c projects/dungeon/src/interface.c unity/Atari/POKEY.s build/atari/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_atarixl.lib
...
utils\py27\python utils\scripts\atari\AtariMerge.py build/atari/xautorun build/atari/basicoff.bin build/atari/dungeon.bin build/atari/rmt.bin
...
utils\scripts\atari\dir2atr.exe -d -B utils/scripts/atari/xboot.obx 720 build/dungeon-atari.atr build\atari

echo DONE
pause

cd "utils\emulators\Altirra-3.20"
Altirra.exe "..\..\..\build\dungeon-atari.atr"
