...
utils\py27\python utils\scripts\atari\AtariBitmap.py projects/goblin/bitmaps/banner-atari.png build/atari/banner.img
utils\py27\python utils\scripts\atari\AtariBitmap.py projects/goblin/bitmaps/scene1-atari.png build/atari/scene1.img
utils\py27\python utils\scripts\atari\AtariSprites.py projects/goblin/sprites/sprites-atari.png build/atari/sprites.dat 26
utils\py27\python utils\scripts\ProcessChunks.py atari projects/goblin/chunks/chunks-atari.txt build/atari/
copy projects\goblin\music\goblin-atari.rmt build\atari\goblin.mus
...
utils\cc65\bin\cl65 -o build/atari/goblin.bin -m build/goblin-atari.map -Cl -O -t atarixl -Wl -D,__STACKSIZE__=$0400 -C atarixl-largehimem.cfg -I unity projects/goblin/src/goblin.c projects/goblin/src/chunks.c projects/goblin/src/interface.c projects/goblin/src/scene.c unity/Atari/POKEY.s build/atari/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_atarixl.lib
...
utils\py27\python utils\scripts\atari\AtariMerge.py build/atari/xautorun build/atari/basicoff.bin build/atari/goblin.bin build/atari/rmt.bin
...
utils\scripts\atari\dir2atr.exe -d -B utils/scripts/atari/xboot.obx 720 build/goblin-atari.atr build\atari

echo DONE
pause

cd "utils\emulators\Altirra-3.20"
Altirra.exe "..\..\..\build\goblin-atari.atr"
