...
utils\py27\python utils\scripts\apple\AppleBitmap.py double projects/grubs/bitmaps/banner-apple.png build/apple/banner.img
utils\py27\python utils\scripts\apple\AppleBitmap.py double projects/grubs/bitmaps/pumpkins-apple.png build/apple/pumpkins.img
utils\py27\python utils\scripts\apple\AppleSprites.py double projects/grubs/sprites/sprites-apple.png build/apple/sprites.dat 13
...
utils\cc65\bin\cl65 -o build/apple/grubs.bin -m build/grubs-apple128k.map -Cl -O -t apple2 -D __DHR__ -Wl -D,__STACKSIZE__=$0400,-D,__HIMEM__=$BC00,-D,__LCADDR__=$D000,-D,__LCSIZE__=$1000 -C apple2-hgr.cfg -I unity projects/grubs/src/grubs.c build/apple/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_apple2.lib

utils\scripts\exomizer-3.0.2.exe sfx bin build/apple/grubs.bin -o build/apple/loader

echo DONE!

echo --------------- APPLE DISK BUILDER --------------- 

copy utils\scripts\apple\ProDOS190.dsk build\grubs-apple128k.do
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -as build/grubs-apple128k.do LOADER bin 0x0803 < build/apple/loader
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/grubs-apple128k.do SPRITES.DAT bin < build/apple/sprites.dat
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/grubs-apple128k.do BANNER.IMG bin < build/apple/banner.img
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/grubs-apple128k.do PUMPKINS.IMG bin < build/apple/pumpkins.img

echo DONE
pause

cd "utils\emulators\AppleWin-1.26.3.1"
Applewin.exe -d1 "..\..\..\build\grubs-apple128k.do"
