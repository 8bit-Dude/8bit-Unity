...
utils\py27\python utils\scripts\apple\AppleBitmap.py double projects/demos/bitmaps/banner-apple.png build/apple/banner.img
utils\py27\python utils\scripts\apple\AppleBitmap.py double projects/demos/bitmaps/stadium-apple.png build/apple/stadium.img
utils\py27\python utils\scripts\apple\AppleSprites.py double projects/demos/sprites/sprites-apple.png build/apple/sprites.dat 5
...
utils\cc65\bin\cl65 -o build/apple/demos.bin -m build/demos-apple128k.map -Cl -O -t apple2 -D __DHR__ -Wl -D,__STACKSIZE__=$0400,-D,__HIMEM__=$BC00,-D,__LCADDR__=$D000,-D,__LCSIZE__=$1000 -C apple2-hgr.cfg -I unity projects/demos/src/demo.c projects/demos/src/demo-bitmap.c projects/demos/src/demo-controls.c projects/demos/src/demo-gfx.c projects/demos/src/demo-hello.c projects/demos/src/demo-network.c projects/demos/src/demo-sprites.c build/apple/unity.lib unity/IP65/ip65_tcp.lib unity/IP65/ip65_apple2.lib

utils\scripts\exomizer-3.0.2.exe sfx bin build/apple/demos.bin -o build/apple/loader

echo DONE!

echo --------------- APPLE DISK BUILDER --------------- 

copy utils\scripts\apple\ProDOS190.dsk build\demos-apple128k.do
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -as build/demos-apple128k.do LOADER bin 0x0803 < build/apple/loader
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/demos-apple128k.do SPRITES.DAT bin < build/apple/sprites.dat
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/demos-apple128k.do BANNER.IMG bin < build/apple/banner.img
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/demos-apple128k.do STADIUM.IMG bin < build/apple/stadium.img
utils\java\bin\java -jar utils\scripts\apple\AppleCommander-1.6.0.jar -p build/demos-apple128k.do DEMO.MUS bin < projects/demos/music/demo-apple.m

echo DONE
pause

cd "utils\emulators\AppleWin-1.26.3.1"
Applewin.exe -d1 "..\..\..\build\demos-apple128k.do"
