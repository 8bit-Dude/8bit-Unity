...
copy ..\..\projects\grubs\bitmaps\banner-lynx.png banner.png
..\..\utils\scripts\png2bmp banner.png
..\..\utils\scripts\lynx\sprpck -t6 -p2 -u banner.bmp
copy ..\..\projects\grubs\bitmaps\pumpkins-lynx.png pumpkins.png
..\..\utils\scripts\png2bmp pumpkins.png
..\..\utils\scripts\lynx\sprpck -t6 -p2 -u pumpkins.bmp

copy ..\..\projects\grubs\sprites\sprites-lynx.png sprites.png
..\..\utils\scripts\png2bmp sprites.png
..\..\utils\scripts\lynx\sprpck -t6 -p2 -u -r001016 -S007011 -a003005 sprites.bmp

set /a CHUNKNUM=0
set /a FILENUM=!CHUNKNUM!+2
...
set FILESIZES=
for %%I in (banner.spr,pumpkins.spr) do set FILESIZES=!FILESIZES!%%~zI,
...
utils\py27\python utils/scripts/lynx/LynxConfig.py unity/Lynx/lynx.cfg build/lynx/lynx.cfg 2 0 0 %CHUNKNUM%
utils\py27\python utils/scripts/lynx/LynxDirectory.py unity/Lynx/directory.s build/lynx/directory.asm 2 0 0 %CHUNKNUM%
...
utils\cc65\bin\cl65 -o build/grubs-lynx.lnx -m build/grubs-lynx.map -Cl -O -t lynx -C build/lynx/lynx.cfg -I unity projects/grubs/src/grubs.c unity/Lynx/sfx.s build/lynx/directory.asm build/lynx/data.asm build/lynx/unity.lib
...
handy.exe "..\..\..\build\grubs-lynx.lnx"
